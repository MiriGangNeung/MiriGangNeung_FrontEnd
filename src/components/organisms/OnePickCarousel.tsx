        ...
        {options.map((opt, i) => {
          ...
          return (
            <div
              ...
              className={`relative w-[82vw] max-w-[340px] shrink-0 cursor-pointer snap-center overflow-hidden rounded-[20px] border bg-white text-left transition duration-300 ease-[cubic-bezier(.22,1,.36,1)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand sm:absolute sm:left-1/2 sm:top-0 sm:w-[248px] sm:[transition-duration:450ms] sm:[transition-property:transform,opacity,filter,box-shadow] ${
            ...
            >
              ...
              <div className={`px-4 pb-4 pt-3 sm:px-[18px] ${selected ? 'bg-brand-tint/40' : ''}`}>
                ...
                <div
                  className={`mt-2.5 text-xs font-bold ${selected ? 'text-brand' : 'text-ink-soft'}`}
                >
